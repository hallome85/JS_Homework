...
console.log(qa.getInfo('Hello, dear fried')); */
...
/*2. Changing the context
  ...
  /*const anotherQa = {name: 'John Doe', age: 63, salary: 250000};
console.log(qa.getInfo.bind(anotherQa)('Yo'));
console.log(qa.getInfo.call(anotherQa,'Yo'));
